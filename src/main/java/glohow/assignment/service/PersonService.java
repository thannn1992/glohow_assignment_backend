...
public class PersonService {
    ...
    public void addPersonAndUpdateRelationship(Person person1, String roleNamePerson1, Person person2, String roleNamePerson2, Date relationshipStartDate, String relationshipTypesName1, String relationshipTypesName2, String mainGenealogyPerson2) {
        ...
        RelationshipTypes relationshipTypes1 = relationshipTypesRepository.findByRelationshipTypeDescription(relationshipTypesName1);
        RelationshipTypes relationshipTypes2 = relationshipTypesRepository.findByRelationshipTypeDescription(relationshipTypesName2);

        //update relationship1 for person1
        Relationships relationships1 = setRelationshipToPerson2(existingPerson1, rolePerson1, person2, rolePerson2, relationshipTypes1, relationshipStartDate);
        //update relationship2 for person2
        Relationships relationships2 = setRelationshipToPerson1(existingPerson1, rolePerson1, person2, rolePerson2, relationshipTypes2, relationshipStartDate);
        ...
        if (rolePerson1.getRoleDescription().equals("Father") || rolePerson1.getRoleDescription().equals("Mother")) {
            ...
            List<Person> children = personRepository.findPerson02ByPerson01IdAndRelationshipTypeDescription(existingPerson1.getPersonID(), "Parent");
            if (!children.isEmpty()) {
            ...
            if (!spousePerson.isEmpty()) {
                RelationshipTypes relationshipTypesParentChild = relationshipTypesRepository.findByRelationshipTypeDescription("Parent");
                RelationshipTypes relationshipTypesChildParent = relationshipTypesRepository.findByRelationshipTypeDescription("Children");
                spousePerson.forEach(spouse -> {
                    ...
                    Relationships relationshipsParentChild2 = setRelationshipToPerson1(existSpouse, rolesSpouse, existingPerson2, rolesChildren, relationshipTypesChildParent, existingPerson2.getDoB());
        ...
        if (rolePerson2.getRoleDescription().equals("Father") || rolePerson2.getRoleDescription().equals("Mother")) {
            ...
            if (rolePerson2.getRoleDescription().equals("Father")) {
                ...
                if (!listPerson.isEmpty()) {
                    ...
                    RelationshipTypes relationshipTypesMarried = relationshipTypesRepository.findByRelationshipTypeDescription("Married");
                    ...
                    relationships3.setRelationshipTypes(relationshipTypesMarried);
                    ...
                    relationships4.setRelationshipTypes(relationshipTypesMarried);
        ...
        if (rolePerson2.getRoleDescription().equals("Husband") || rolePerson2.getRoleDescription().equals("Wife")) {
            ...
            existingPerson2.setMaritalStatus("Married");
            List<Person> listPerson = personRepository.findPerson02ByPerson01IdAndRelationshipTypeDescription(existingPerson2.getPersonID(), "Married");
            ...
            existPersonSpouse.setMaritalStatus("Married");
            personRepository.save(existPersonSpouse);
            personRepository.save(existingPerson2);
            ...
            if (!children.isEmpty()) {
                ...
                children.forEach(child -> {
                    ...
                    Relationships relationshipsChildToParent = setRelationshipToPerson1(existingPerson2, rolesParents, existPersonChild, rolesChild, relationshipTypesChildParent, existPersonChild.getDoB());
    ...
    public Relationships setRelationshipToPerson2(Person person1, Roles rolePerson1, Person person2, Roles rolePerson2, RelationshipTypes relationshipTypes1, Date relationshipStartDate) {
        ...
        relationships1.setRelationshipTypes(relationshipTypes1);
        relationships1.setDateOfRelationshipStarted(relationshipStartDate);
        return relationships1;
    }

    public Relationships setRelationshipToPerson1(Person person1, Roles rolePerson1, Person person2, Roles rolePerson2, RelationshipTypes relationshipTypes2, Date relationshipStartDate) {
        Relationships relationships1 = new Relationships();
        ...
        relationships1.setRelationshipTypes(relationshipTypes2);
        relationships1.setDateOfRelationshipStarted(relationshipStartDate);
        return relationships1;
    }
    ...
    public void updatePerson(Person person) {
        ...
        if (person.getMaritalStatus().equals("Married")) {
            List<Person> listPerson = personRepository.findPerson02ByPerson01IdAndRelationshipTypeDescription(person.getPersonID(), "Married");
            if (!listPerson.isEmpty()) {
                Person existPersonSpouse = personRepository.findById(listPerson.get(0).getPersonID()).orElseThrow(() -> new RuntimeException("Person not found"));
                existPersonSpouse.setMaritalStatus("Married");
    ...
    public String takeDateOfStartedRel(int personID, String nameOfRel) {

        try {
            String result = personRepository.findDateStartedRelationshipByPersonId(personID, nameOfRel);
            return result;
        } catch (Exception e) {
            return "";
        }
